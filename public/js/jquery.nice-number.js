(function ($) {
	$.fn.niceNumber = function (options) {
		var defaults = {
			autoSize: true,
			autoSizeBuffer: 1,
			buttonDecrement: '<i class="fa-solid fa-minus"></i>' ,
			buttonIncrement: '<i class="fa-solid fa-plus"></i>',
		...
		return this.each(function () {
			...
			// Generate buttons
			var $minusButton = $('<button style="border-radius:4px 0px 0px 4px"/>')
			...
			var $plusButton = $('<button style="border-radius:0px 4px 4px 0px"/>')
				.attr('class', 'button is-black')
				.attr('type', 'button')
